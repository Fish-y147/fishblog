...
![WSL插件](embedded/5.png)

![连接到arch](embedded/6.png)

在 VS Code 左下角可以看到 VS Code 连接成功标志。

![连接到arch](embedded/7.png)
